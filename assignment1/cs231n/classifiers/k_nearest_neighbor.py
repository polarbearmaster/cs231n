...
class KNearestNeighbor(object):
  ...
  def compute_distances_two_loops(self, X):
    ...
    for i in xrange(num_test):
      for j in xrange(num_train):
        ...
        #temp = np.reshape(X[i,:],(X.shape[1],1)) - np.reshape(self.X_train[j,:],(self.X_train.shape[1],1))
        #dists[i][j] = np.linalg.norm(temp)
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in xrange(num_test):
      ...
      #######################################################################
      #temp = np.reshape(X[i,:],(1,X.shape[1])) - self.X_train
      #dists[i,:] = np.linalg.norm(temp)
